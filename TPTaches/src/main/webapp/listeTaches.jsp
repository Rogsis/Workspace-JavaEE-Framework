...
<body>
	...
	<div class="container">
		<h1 class="bleu">Gestion des tâches</h1>
		<br> <br>
		<table class="table table-hover table-striped">
			...
			<c:forEach items="${taches}" var="t" varStatus="bStatus">
		...
		<br><br><br>
		<h2 class="bleu">Nouvelle tâche :</h2>
		<div>
			<form action="ajouterTache" method="POST" class="form-horizontal" >
				<div class="form-group">
					<div class="col-xs-10">
						<input name="libelle" placeholder="Libellé de la tâche ..."
							class="form-control"  />
					</div>
					<div class="col-xs-10">
						<input name="importance" placeholder="[1:10]"
							class="form-control"  />
					</div>
					<div class="col-xs-2">
