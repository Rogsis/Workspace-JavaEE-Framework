...
<title>Insert title here</title>
	...
	<script src="${pageContext.request.contextPath}/js/commun.js"></script>
...
<body>
	...
	<table class="table table-hover table-striped">
		...
		<c:forEach items="${listeF}" var="f" varStatus="bStatus">
			<tr>
				<td><a href="afficher?id=${f.id}">${f.titre}</a></td>
				<td>${f.annee}</td>
				...
				<td>${f.vu?"Oui":"Non"}</td>
				<td class="centre">
					<span class="modif glyphicon glyphicon-edit vert"  id="${f.id}"></span>
				</td>
				<td class="centre">
					<span class="glyphicon glyphicon-remove rouge supp"  id="${f.id}"></span>
				</td>
			</tr>
		</c:forEach>
	</table>
